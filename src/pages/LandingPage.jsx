...
const LandingPage = () => {
  ...
  return (
    <div style={{ position: "relative", minHeight: "100vh" }}>
      {isModalOpen && <div style={blurBackgroundStyle}></div>}
      <Landingpagenavbar />
      <div
        style={{
          display: "flex",
              ...
              >
                ...
                <span
                  style={{
                    ...
                    fontSize: "11px",
                    fontWeight:
                      selectedRentalType === rentalType ? "bold" : "normal",
                    color:
                      selectedRentalType === rentalType ? "skyblue" : "black",
                  }}
                >
      ...
      <div>
        ...
        >
          {filteredGridData
            .filter(
              (post) =>
                selectedRentalType === "all" ||
                post.rentalType === selectedRentalType
            )
            .map((post) => (
              <Link
                key={post.id}
